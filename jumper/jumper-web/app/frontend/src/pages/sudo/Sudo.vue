        ...
        <div class="ui grid">
            ...
            <div class = "ui row">
                ...
                <div class="right aligned five wide column">
                    <router-link  :to="{ path: '/sudo_user'}" style="color: darkgreen; font-size: small; text-decoration:underline">点击查看某用户的所有继承权限</router-link>
                </div>
            </div>
                ...
                <tbody>
                    <tr v-for="(info , index) in sudo_list.objects">
                        ...
                        <td>
                            ...
                            <div class="ui green label" v-else-if="!info.life_cycle">永久有效</div>
