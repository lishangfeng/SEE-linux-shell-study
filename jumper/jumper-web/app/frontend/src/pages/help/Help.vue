        ...
        <div class="ui basic segment" id="Content">
            ...
            <div class="item" id="G1">
                ...
                <div class="ui basic segment">
                    新入职的同事需申请新跳板机账号。
                    <p>账号自助流程：<span><a href="http://ttt.dp/?#!/start/32" target="_blank">http://ttt.dp/?#!/start/32</a></span>
                        流程自动完成，
            ...
            <div class="item" id="G4">
                ...
                <div class="ui basic segment">
                    ...
                    <p>在客户端节点如下配置<span style="color: blue;"> /etc/ssh_config </span> （或 <span style="color: blue;">~/.ssh/config </span>
                        ）就可以直接开启ssh multiplexing功能</p>
            ...
            <div class="item" id="G5">
                ...
                <div class="ui basic segment">
                    <p>
                        在办公网环境下，输入命令：ssh  域账号@jumper.dper.com.&nbsp;&nbsp;&nbsp;若当前用户和域账号一致，也可直接输入命令：ssh  jumper.dper.com 登陆.</p>
                    <p style="color: darkred;;"><i class="red info circle icon"></i> 账号密码详情：</p>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1）<span style="color: black"> 密码：</span>自己最近设置的密码。（<span
                            style="color: red"> 是 jumper 密码！！！不是 大象密码！</span>）</p>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2）<span style="color: black"> 动态口令：</span>支持两种动态码（输入一种即可）：1.大象app上的动态口令；2.每次登录jumper，都会在大象上收到如下图的验证码：
                    </p>
                    <img src='../../assets/code.png' style="width:30rem; height: 6rem;margin-left: 60px;">
                </div>
                <p class="bottom-imgWrap"><img src='../../assets/ssh-jumper.gif' alt=""
                                               style="width:30rem; height: 22.5rem;"></p>
            </div>
            <br><br><br>
            <div class="item" id="G6">
                ...
                <div class="ui basic segment">
                    ...
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1）<span style="font-weight: 800"> ctrl+B、ctrl+F 快捷键。</span>终端左右移动光标
                    </p>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2）<span
                            style="font-weight: 800"> Tab</span> 快捷键。自动补全命令、自动匹配查找主机名（仅限历史登陆过的机器）</p>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3）<span
                            style="font-weight: 800"> ping</span> 命令。按ctrl+c中止。</p>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4）<span
                            style="font-weight: 800"> history</span> 命令。输入 ' history ' ,查看历史命令。也可用 "向上/下  方向键" 调出历史命令。
                    </p>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;v5）支持 <span
                            style="font-weight: 800"> expect</span> 交互。</p>

                    <p style="color: darkred;;"><i class="red info circle icon"></i> 技能介绍：</p>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1）<span
                            style="font-weight: 800"> getapp：</span>&nbsp;&nbsp;&nbsp;得到某应用的（线上）机器列表。命令输入：getapp 应用名 [ 例：getapp  op-duty  ]
                    </p>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2）<span
                            style="font-weight: 800"> pssh：</span> &nbsp;&nbsp;&nbsp;某个应用，所有线上机器，批量执行命令。命令输入：pssh 应用名 命令 [ 例：pssh op-duty uptime |awk '{print $1}'
                    </p>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3）<span
                            style="font-weight: 800"> plog：</span> &nbsp;&nbsp;&nbsp;某个应用，所有线上机器，批量查询日志命令,其中grep查询条件为必填。命令输入：plog 应用名 'grep查询条件' 日期
                    </p>
                </div>
            ...
            <div class="item" id="G7">
                ...
                <div class="ui basic segment">
                    ...
                    <p class="bottom-imgWrap"><img src='../../assets/sftp-exp.png' style="width: 30rem; height: 13rem;">
                    </p>
                </div>
                <p><i class="blue arrow right icon"></i>命令行（local）</p>
                <p class="bottom-imgWrap"><img src='../../assets/sftp-local.gif' alt=""></p>
                <p><i class="blue arrow right icon"></i>命令行（remote）</p>
                <p class="bottom-imgWrap"><img src='../../assets/sftp-host.gif' alt=""></p>
                <p><i class="blue arrow right icon"></i>工具(filezilla)</p>
                <p class="bottom-imgWrap"><img src='../../assets/sftp-filezilla.gif' alt=""></p>
            ...
            <div class="item" id="G9">
                ...
                <div class="ui divider"></div>
                <div class="ui basic segment">
                    <p><i class="blue arrow right icon"></i><span>&nbsp;前往&nbsp;&nbsp;<a
                            href="http://ttt.dp/?#!/start/32" target="_blank">http://ttt.dp/?#!/start/32</a></span>
                        提交流程，找对应SRE审批。
            ...
            <div class="item" id="G10">
                ...
                <div class="ui basic segment">
                    ...
                    <p class="bottom-imgWrap"><img src='../../assets/windows-secure-1.png'
                                                   style="width:22rem; height: 20rem;">
                        <img src='../../assets/windows-secure-2.png' style="width:22rem; height: 20rem;">
                        &nbsp;&nbsp;&nbsp;<img src='../../assets/windows-secure-3.png' style="width:22rem; height: 20rem;">
                    </p>
                </div>
            </div>
            <br><br><br>
            <div class="item" id="G11">
                ...
                <div class="ui basic segment">
                    ...
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;详细操作步骤见链接： <a
                            href="http://jingyan.baidu.com/article/948f59245be128d80ff5f9aa.html">http://jingyan.baidu.com/article/948f59245be128d80ff5f9aa.html</a>
                    </p>
                    <br>
                    <p style="font-weight: 800; color: black;"><i class="blue arrow right icon"></i>密码错误问题</p>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;忘记密码?<a href="http://ttt.dp/#!/start/32" target="_blank">http://ttt.dp/#!/start/32</a>
                        密码重置,</p>
